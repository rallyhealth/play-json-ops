...
object JsonMacroOps {
   ...
   *
   * OFormats have writes that return JsObject instead of JsValue, which will always be correct
   ...
   *
   * OWritess have writes that return JsObject instead of JsValue, which will always be correct
